...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        #don't remove user field, data migration will be performed
        #Deleting field 'Notice.user'
        #db.delete_column('notification_notice', 'user_id')

        # Adding field 'Notice.recipient'
        db.add_column('notification_notice', 'recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recieved_notices',null=True, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        #Don't add field 'Notice.user', it wasn't removed
        #db.add_column('notification_notice', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']), keep_default=False)

        # Deleting field 'Notice.recipient'
        db.delete_column('notification_notice', 'recipient_id')
    ...
    models = {
        ...
        'notification.notice': {
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recieved_notices'", 'to': "orm['auth.User']", 'null':'True'}),
