...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notice.recipient'
        db.alter_column('notification_notice', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):

        # We cannot add back in field 'Notice.user'
        raise RuntimeError(
            "Cannot reverse this migration. 'Notice.user' and its values cannot be restored.")
