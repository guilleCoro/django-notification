...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notice.message_header'
        db.add_column('notification_notice', 'message_header', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notice.message_header'
        db.delete_column('notification_notice', 'message_header')
    ...
    models = {
        ...
        'notification.notice': {
            ...
            'message_header': ('django.db.models.fields.TextField', [], {'default': "''"}),
